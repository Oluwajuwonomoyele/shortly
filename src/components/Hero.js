...
export default function Hero() {
  return (
    <section>
      <div className='container mx-auto overflow-x-hidden pb-40 lg:flex lg:flex-row-reverse lg:items-center lg:pt-14 lg:pl-8'>
        ...
        <div className='px-4 text-center lg:text-left mt-10 lg:mt-0 flex flex-col items-center lg:items-start gap-4 lg:basis-[60%]'>
          <h1 className='text-4xl lg:text-6xl font-bold text-neutral-very-dark-blue'>More than just shorter links</h1>
          ...
          <button className='bg-primary-cyan text-white py-3 px-8 rounded-full cursor-pointer lg:mt-4 hover:opacity-70 transition-all duration-200 ease-linear'>Get Started</button>
        </div>
      </div>
    </section>
  )
